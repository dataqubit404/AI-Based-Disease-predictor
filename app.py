...
/* Headers and Subheaders in Glass Card (exclude st.title) */
h2, h3 {
    padding: 0.6rem 1rem;
    border-radius: 15px;
...
""", unsafe_allow_html=True)
    ...
    if choice == "Dark":
        ...
        text = "white"
        accent = "#6645b2"
        heading_bg = "rgba(255,255,255,0.05)"
    else:
        bg = "#73a3d1"
        card = "rgba(255,255,255,0.7)"
        text = "#1e293b"
        accent = "#615CC6"
        heading_bg = "rgba(255,255,255,0.7)"
    ...
    st.markdown(f"""
        ...
        /* Headers/Subheaders glass background (h2/h3) */
        h2, h3 {{
